...
class StarProduct {
  ...
  // 虚拟商品字段
  final bool isElectronic; // 是否虚拟商品
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      // 虚拟商品字段
      'is_electronic': isElectronic ? 1 : 0,
    };
  }
  ...
  factory StarProduct.fromMap(Map<String, dynamic> map) {
    return StarProduct(
      ...
      // 虚拟商品字段
      isElectronic: map['is_electronic'] == 1,
    );
  }
}
...
class BillItem {
  ...
  factory BillItem.fromMap(Map<String, dynamic> map) {
    return BillItem(
      ...
      ruleSnapshot: map['rule_snapshot'] as String?,
    );
  }
}
...
class Coupon {
  ...
  final String rewardType; // 'cash' 现金, 'points' 积分
  ...
  factory Coupon.fromMap(Map<String, dynamic> map) {
    return Coupon(
      ...
      code: map['code'],
      type: map['type'],
      rewardType: map['reward_type'] ?? 'cash',
      value: map['value'],
...
class ProductReview {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'images': images?.join(','),
      'created_at': createdAt.millisecondsSinceEpoch,
      'appended_at': appendedAt?.millisecondsSinceEpoch,
      'appended_content': appendedContent,
      'appended_images': appendedImages?.join(','),
      'seller_reply': sellerReply,
      'seller_reply_at': sellerReplyAt?.millisecondsSinceEpoch,
      'status': status,
  ...
  factory ProductReview.fromMap(Map<String, dynamic> map) {
    List<String>? parseImages(dynamic value) {
      ...
      if (value is String && value.isNotEmpty && value != '[]') {
        try {
          return List<String>.from(const JsonDecoder().convert(value));
        } catch (_) {
    ...
    return ProductReview(
      id: map['id'],
      orderId: map['order_id'],
      productId: map['product_id'] is int ? map['product_id'] : int.parse(map['product_id'].toString()),
      ...
      createdAt: DateTime.fromMillisecondsSinceEpoch(map['created_at']),
      appendedAt: map['appended_at'] != null ? DateTime.fromMillisecondsSinceEpoch(map['appended_at']) : null,
      appendedContent: map['appended_content'],
      appendedImages: parseImages(map['appended_images']),
      sellerReply: map['seller_reply'],
      sellerReplyAt: map['seller_reply_at'] != null ? DateTime.fromMillisecondsSinceEpoch(map['seller_reply_at']) : null,
      status: map['status'] ?? 'pending',
  ...
  ProductReview copyWith({
    ...
    return ProductReview(
      ...
      sellerReplyAt: sellerReplyAt ?? this.sellerReplyAt,
...
class Promotion {
  ...
  factory Promotion.fromMap(Map<String, dynamic> map) {
    return Promotion(
      ...
      type: map['type'] as String? ?? 'full_reduction',
      thresholdAmount: map['threshold_amount'] as int? ?? 0,
...
class CardSecret {
  ...
  factory CardSecret.fromMap(Map<String, dynamic> map) {
    return CardSecret(
      id: map['id'],
      ...
      cardSecret: map['card_secret'] as String,
      ...
      usedAt: map['used_at'] != null ? DateTime.fromMillisecondsSinceEpoch(map['used_at'] as int) : null,
    );
  }
  ...
  CardSecret copyWith({
    ...
    return CardSecret(
      ...
      cardSecret: cardSecret ?? this.cardSecret,
      status: status ?? this.status,
...
class BrowsingHistory {
  ...
  factory BrowsingHistory.fromMap(Map<String, dynamic> map) {
    return BrowsingHistory(
      ...
      productPoints: map['product_points'] as int? ?? 0,
