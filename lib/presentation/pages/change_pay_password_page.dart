  ...
  Future<void> _checkIfHasPayPassword() async {
    try {
      ...
      if (securityState is SecurityLoaded) {
        ...
        if (userData != null) {
          String? currentPayPasswordHash;
          if (userData.containsKey('buyer_extension') && userData['buyer_extension'] != null) {
            currentPayPasswordHash = userData['buyer_extension']['pay_password_hash']?.toString();
          } else if (userData.containsKey('seller_extension') && userData['seller_extension'] != null) {
            currentPayPasswordHash = userData['seller_extension']['pay_password_hash']?.toString();
          } else if (userData.containsKey('admin_extension') && userData['admin_extension'] != null) {
            currentPayPasswordHash = userData['admin_extension']['pay_password_hash']?.toString();
          } else {
            currentPayPasswordHash = userData['pay_password_hash']?.toString();
          }
          setState(() {
