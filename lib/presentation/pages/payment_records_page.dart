          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                ...
                try {
                  final databaseService = ProductDatabaseService();
                  await databaseService.updatePaymentRecordFundStatus(record.orderId, 'refunded');
                  await _loadPaymentRecords();
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('退款成功，金额 ¥${record.amount.toStringAsFixed(2)} 已原路退回', style: TextStyle(color: theme.colorScheme.onPrimary)),
