...
class _AfterSalesApplyPageState extends State<AfterSalesApplyPage> {
  ...
  Future<void> _submitAfterSalesApply() async {
    ...
    // 检查物流信息（仅退款退货和换货需要）
    if (_afterSalesType == 'returnGoods' || _afterSalesType == 'exchange') {
    ...
    debugPrint('订单状态已更新为$statusText');
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildDivider(),
                  _buildRadioItem('exchange', '换货', _afterSalesType),
                  _buildDivider(),
                  _buildRadioItem('priceProtection', '价保补差', _afterSalesType),
                  _buildDivider(),
